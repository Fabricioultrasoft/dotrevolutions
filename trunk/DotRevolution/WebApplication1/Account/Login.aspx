...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        Por favor entre com o nome de Usuário e Senha.
        <asp:HyperLink ID="RegisterHyperLink" runat="server" EnableViewState="false">Cadastrar</asp:HyperLink> Caso não possua uma conta.
    </p>
